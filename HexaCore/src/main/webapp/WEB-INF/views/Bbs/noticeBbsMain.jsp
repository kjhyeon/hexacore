...
<script type="text/javascript">
	function writeForm(){
		location.href="./noticeBbsInsert.do";
	}
	...
	function chkbox(){
		 ...
		 if (n > 0) {
			document.getElementById("multidel").action = "./NoticeMultiDel.do";
		 } else {
			alert("삭제할게 없네요?");
			return false;
		 }
	...
	function goPage(page){
		var location = "./noticeBbsMain.do?page="+page; 
...
<div id="Main_Top_Div">
	...
	<form action="./NoticeMultiDel.do" method="POST" id="List" name="List" onsubmit="return chkbox()">
	<input type="hidden" name="auth_check" value="${auth}">
      ...
      <c:forEach var="dto" items="${lists}" varStatus="vr">
      		<tr class="Main_Tbody">
      			...
      			<td id="td2">${dto.id}</td>
      			<td><a href="noticeBbsDetail.do?seq=${dto.seq}" style="text-decoration: none; color: black; font-weight: bold;">
