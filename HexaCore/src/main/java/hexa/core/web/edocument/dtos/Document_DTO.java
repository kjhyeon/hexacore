...
public class Document_DTO {
	...
	public Document_DTO(int seq, String author, String title, String content, int type_seq, int state, Date regdate,
			int appr_turn) {
		super();
		this.seq = seq;
		this.author = author;
	...
	public String toString() {
		return "Document_DTO [seq=" + seq + ", author=" + author + ", title=" + title + ", content=" + content
